    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-6 text-sm">
                ...
                <a href="/theater" className="text-yellow-600 font-medium">
                  Театр
                </a>
      ...
      <div className="container mx-auto px-4 py-16 max-w-2xl text-center">
        <div className="bg-gray-50 rounded-2xl p-12">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Театр</h1>
          <p className="text-gray-600 mb-8 text-lg">
            Для просмотра информации о театральных постановках и покупки билетов необходимо войти в личный кабинет
          </p>
          <button
            onClick={() => setIsLoginModalOpen(true)}
